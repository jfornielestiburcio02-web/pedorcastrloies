...
<div class="contenedor">
    ...
    <?php else: ?>
        ...
        <?php if (tienePermiso($misRoles, 'EsDireccion')): ?>
            <a href="menu.php?p=DIR" class="boton-perfil">EQUIPO DIRECTIVO</a>
        <?php endif; ?>

        <?php if (tienePermiso($misRoles, 'EsSecretaria')): ?>
            <a href="menu.php?p=SEC" class="boton-perfil">GESTIÓN DE SECRETARÍA</a>
        <?php endif; ?>

        <?php if (tienePermiso($misRoles, 'EsProfesor')): ?>
            <a href="menu.php?p=PRO" class="boton-perfil">PERFIL DOCENTE</a>
        <?php endif; ?>

        <?php if (tienePermiso($misRoles, 'EsAlumno')): ?>
            <a href="menu.php?p=ALU" class="boton-perfil">PERFIL ALUMNADO</a>
        <?php endif; ?>

        <?php if (tienePermiso($misRoles, 'EsCiudadano')): ?>
            <a href="menu.php?p=CIU" class="boton-perfil">PERFIL CIUDADANO</a>
        <?php endif; ?>
